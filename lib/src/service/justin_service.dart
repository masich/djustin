...
class JustinService extends Service {
  JustinService({String endpointBase = endpoints.justinBase, http.Client client})
  ...
  Future<Response<BranchType>> getBranchTypesResponse({OnHttpErrorCallback onHttpError}) {
    return getResponseDirect(endpoints.justinBranchTypes, BranchTypeConverter(), onHttpError: onHttpError);
  }
  ...
  Future<Response<Locality>> getLocalitiesAllResponse({OnHttpErrorCallback onHttpError}) {
    return getResponseDirect(endpoints.justinLocalities, LocalityConverter(), onHttpError: onHttpError);
  }
  ...
  Future<Response<ServiceInfo>> getServicesInfoResponse({OnHttpErrorCallback onHttpError}) {
    return getResponseDirect(endpoints.justinServicesInfo, ServiceInfoConverter(), onHttpError: onHttpError);
  }

  Future<Response<Branch>> getBranchesAllResponse({OnHttpErrorCallback onHttpError}) {
    return getResponseDirect(endpoints.justinBranches, BranchConverter(), onHttpError: onHttpError);
  }
  ...
  static void _defaultErrorHandler(int status, ResponseMessage message) {
    print("Justin response contains an error. Status: '$status'; Message: '$message'");
  }
}
